...
import { CrossChainRadar } from '@/components/governada/charts/CrossChainRadar';
import { VotingPowerTreemap } from '@/components/governada/charts/VotingPowerTreemap';
...
export function GovernadaObservatory() {
  const {
    data: rawGHI,
