...
import { tierKey, TIER_SCORE_COLOR, TIER_BADGE_BG } from '@/components/governada/cards/tierStyles';
import { computeTier } from '@/lib/scoring/tiers';
import { TrendingUp, TrendingDown, Minus } from 'lucide-react';
import { GovernanceHealthGauge } from '@/components/governada/charts/GovernanceHealthGauge';
import { ActivityHeatmap } from '@/components/governada/charts/ActivityHeatmap';
...
export function GovernadaGovernanceTrends() {
  const {
    data: rawSparklines,
