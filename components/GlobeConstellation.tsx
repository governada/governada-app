...
// changes. This module-level variable is readable from useFrame without React props.
...
>(function GlobeConstellation(
  ...
  // Sync focus state to module-level variable on every render.
  // This bridges React outer tree → R3F Canvas tree (which doesn't re-render).
  // NodePoints' useFrame reads _sharedFocus/_sharedFocusVersion directly.
...
function NodePoints({
  ...
  useFrame((_, delta) => {
    ...
    // No React props or refs — pure JS module scope, always readable.
