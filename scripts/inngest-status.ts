...
const EXPECTED_FUNCTIONS = [
  ...
  'precompute-citizen-summaries',
  'generate-governance-wrapped',
  'generate-weekly-digest',
  'notify-epoch-recap',
  'sync-data-moat',
  'sync-catalyst',
  'sync-cc-rationales',
  'generate-citizen-briefings',
  'generate-drep-epoch-updates',
  'precompute-engagement-signals',
  'generate-citizen-assembly',
  'track-proposal-outcomes',
  'compute-community-intelligence',
  'notify-engagement-outcomes',
  'snapshot-citizen-rings',
  'generate-proposal-brief-on-demand',
  'generate-proposal-briefs-batch',
  'compute-cc-relations',
  'analyze-cc-rationales',
  'generate-cc-briefing',
