...
export function GovernadaWordmark({
  ...
  return (
    ...
    >
      ...
      />
      {size === 'default' && (
        <span className="text-[15px] font-semibold tracking-tight bg-gradient-to-r from-[oklch(0.82_0.10_192)] via-[oklch(0.85_0.10_75)] to-[oklch(0.80_0.12_295)] bg-clip-text text-transparent">
          overnada
        </span>
      )}
    </Link>
