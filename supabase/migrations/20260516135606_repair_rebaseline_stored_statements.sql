-- F4: Repair Supabase preview-branch replay by replacing the stored
-- schema_rebaseline statements with the repo pg_dump content.
-- This mutates Supabase migration metadata only; production schema objects are
-- unchanged. The prior 706-statement metadata bundle is snapshotted below for
-- rollback.

BEGIN;

CREATE TABLE IF NOT EXISTS supabase_migrations.audit_rebaseline_stored_statements_20260516135606 (
  ...
  PRIMARY KEY (version, snapshot_reason)
);
