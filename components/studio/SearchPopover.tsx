...
export function SearchPopover({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
      ...
      <div
        className="relative w-full max-w-lg mx-4 rounded-xl border border-border bg-background shadow-2xl flex flex-col overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150"
